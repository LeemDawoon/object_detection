...
def main(args=None):
    ...
    print('==> int((len(validation_generator)//args.batch_size)', int((len(validation_generator)//args.batch_size)))
    # start training
    return training_model.fit_generator(
        ...
        validation_steps=int((len(validation_generator)//args.batch_size)),
